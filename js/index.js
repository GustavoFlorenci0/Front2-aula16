...
console.log(baseDeDados.resultado[0].nome.primeiro);
...
function renderizarDadosUsuario(dados) {
    ...
    const elementoPai = document.getElementById("card");

    elementoPai.innerHTML = `   
                                    <h1 id= "nome" >${dados.resultado[0].nome.primeiro + " " + dados.resultado[0].nome.utlimo}</h1>                                    
                                    <img src="${dados.resultado[0].imagem.grande}" id="imgFoto">
                                    <p id="emailCards" >  ${dados.resultado[0].email} </p>
